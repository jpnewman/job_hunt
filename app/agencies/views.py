...
@mod.route('/agencies/', methods=['GET'])
def agencies_view_all():
    agencies = Agency.query.all()
    return render_template('agencies/index.html', agencies=agencies)


@mod.route('/agencies/add', methods=['GET', 'POST'])
def agencies_add():
    ...
    return render_template('agencies/add.html', form=form, agencies=agencies)
